...
class FrontendGym:
    """Aplicación gráfica del gimnasio (Tkinter).

        Maneja la interfaz de usuario, música, sonidos, y conecta con
        la lógica de negocio a través de SistemaGimnasio.

        Attributes:
            root (tk.Tk): Ventana principal.
            sistema (SistemaGimnasio): Instancia del sistema central.
            usuario_actual (Usuario): Usuario logueado.
            musica (list): Rutas de archivos de audio.
            indice_musica (int): Índice de la canción actual.
            muteado (bool): Estado del volumen de música.
            content (tk.Frame): Frame dinámico para las vistas.
        """

    def __init__(self, root):

        """Inicializa la interfaz gráfica, configura sonido y muestra la pantalla de bienvenida."""
    ...
    def sonido_click(self):
        """Reproduce un sonido corto de clic."""
        try:
    ...
    def reproducir_musica(self):
        """Carga y reproduce la canción actual (en loop infinito)."""
    ...
    def siguiente_cancion(self):
        """Cambia a la siguiente canción de la lista y la reproduce."""
    ...
    def mutear(self):
        """Activa o desactiva el volumen de la música (mute/unmute)."""
    ...
    def pantalla_bienvenida(self):
        """Muestra la pantalla inicial con logo, título y botón ENTRAR."""
    ...
    def pantalla_login(self):
        """Muestra el formulario de inicio de sesión (usuario/contraseña)."""
    ...
    def login(self):
        """Valida las credenciales y, si son correctas, abre el menú principal."""
    ...
    def menu_principal(self):
        """Construye el menú lateral (sidebar) y el área de contenido principal."""
    ...
    def vista_clientes(self):
        """Muestra la tabla de clientes y los botones de gestión (CRUD)."""
    ...
    def popup_registrar_cliente(self):
        """Abre una ventana emergente para registrar un nuevo cliente."""
    ...
    def popup_actualizar_cliente(self):
        """Abre una ventana emergente para actualizar los datos de un cliente seleccionado."""
    ...
    def vista_acceso(self):
        """Muestra la pantalla de control de acceso con entrada de ID y validación."""
        ...
        def validar():
            """Valida que el acceso sea permitido"""
    ...
    def vista_usuarios(self):
        """Muestra la tabla de usuarios y botones de gestión (solo admin)."""
    ...
    def popup_registrar_usuario(self):
        """Abre ventana para registrar un nuevo usuario (solo admin)."""
    ...
    def popup_actualizar_usuario(self):
        """Abre ventana para actualizar datos de un usuario seleccionado."""
        ...
        def actualizar():
            """Actualiza la ventana de usuario"""
    ...
    def eliminar_usuario_front(self):
        """Elimina el usuario seleccionado (solo admin)."""
    ...
    def vista_auditoria(self):
        """Muestra el registro de auditoría completo (solo admin)."""
