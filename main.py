...
class BaseDeDatos:
    """Maneja la conexión y operaciones básicas con SQLite.

        Proporciona métodos para conectar, crear tablas, ejecutar consultas,
        commits y cerrar la conexión.

        Attributes:
            nombre_bd (str): Ruta del archivo de base de datos.
            conexion (sqlite3.Connection): Objeto conexión.
            cursor (sqlite3.Cursor): Cursor para ejecutar consultas.
        """
    def __init__(self, nombre_bd="gimnasio.db"):
        """Inicializa el gestor con el nombre del archivo de BD."""
        self.nombre_bd = nombre_bd
        self.conexion = None
        self.cursor = None
    
    def conectar(self):
        """Establece la conexión con la BD, activa claves foráneas y crea las tablas."""
    ...
    def crear_tablas(self):
        """Crea todas las tablas necesarias si no existen (clientes, membresías, accesos, etc.)."""
        self.cursor.execute('''
    ...
    def ejecutar(self, query, parametros=None):
        """Ejecuta una consulta SQL (INSERT, UPDATE, DELETE) sin retornar resultados."""
        if parametros:
...
class SistemaGimnasio:
    """Clase principal que orquesta todos los módulos del gimnasio.

        Conecta la base de datos, los gestores de usuarios y clientes,
        y el control de acceso. Maneja el flujo de la aplicación.

        Attributes:
            db (BaseDeDatos): Instancia de la BD.
            gestor_usuarios (GestorUsuarios): Gestor de usuarios.
            gestor_clientes (GestorClientes): Gestor de clientes.
            control_acceso (ControlAcceso): Control de accesos.
            usuario_actual (Usuario): Usuario logueado.
        """
    def __init__(self):
        """Inicializa la BD, los gestores y crea el admin por defecto."""
        self.db = BaseDeDatos()
        self.db.conectar()
    ...
    def iniciar(self):
        """Inicia el sistema mostrando la pantalla de login y luego el menú principal."""
        print("\n" + "="*50)
    ...
    def pantalla_login(self):
        """Solicita usuario y contraseña por consola e intenta autenticar."""
        print("\n--- INICIO DE SESIÓN ---")
    ...
    def menu_principal(self):
        """Muestra el menú principal por consola según el rol del usuario."""
    ...
    def menu_clientes(self):
        """Submenú con opciones para gestionar clientes (registrar, listar, etc.)."""
        while True:
            print("\n--- GESTIÓN DE CLIENTES ---")
    ...
    def actualizar_cliente(self):
        """Solicita ID y nuevos datos para actualizar un cliente."""
        print("\n--- ACTUALIZAR CLIENTE ---")
        try:
    ...
    def listar_clientes(self):
        """Muestra en consola la lista de clientes con su estado."""
        print("\n--- LISTA DE CLIENTES ---")
    ...
    def eliminar_cliente(self):
        """Elimina un cliente (solo admin) previa confirmación."""
        print("\n--- ELIMINAR CLIENTE ---")
        try:
    ...
    def exportar_csv(self):
        """Genera un archivo CSV con los clientes."""
        try:
    ...
    def menu_acceso(self):
        """Submenú para validar acceso por consola."""
        while True:
            print("\n--- CONTROL DE ACCESO ---")
    ...
    def validar_acceso(self):
        """Solicita un ID y muestra el resultado de la validación."""
        print("\n--- VALIDAR ACCESO ---")
        id_cliente = input("ID del cliente: ")
    ...
    def menu_usuarios(self):
        """Submenú para gestionar usuarios (solo admin)."""
        while True:
            print("\n--- GESTIÓN DE USUARIOS ---")
    ...
    def listar_usuarios(self):
        """Muestra en consola la lista de usuarios."""
        print("\n--- LISTA DE USUARIOS ---")
    ...
    def actualizar_usuario(self):
        """Actualiza nombre o contraseña de un usuario."""
        print("\n--- ACTUALIZAR USUARIO ---")
        try:
    ...
    def eliminar_usuario(self):
        """Elimina un usuario (solo admin, no a sí mismo)."""
        print("\n--- ELIMINAR USUARIO ---")
        try:
    ...
    def menu_auditoria(self):
        """Submenú para consultar registros de auditoría (solo admin)."""
        while True:
    ...
    def ver_auditoria(self):
        """Muestra los últimos 50 registros de auditoría."""
        query = """
    ...
    def filtrar_auditoria_tabla(self):
        """Filtra auditoría por nombre de tabla."""
    ...
    def filtrar_auditoria_trabajador(self):
        """Filtra auditoría por ID de trabajador."""
        try:
    ...
    def _mostrar_auditoria(self, registros):
        """Imprime formateada una lista de registros de auditoría.

           Args:
              registros (list of tuple): Filas de auditoría.
        """
